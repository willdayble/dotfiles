...
```bash
git clone https://github.com/lukegiuliani/dotfiles.git && cd ~/dev/dotfiles && ./bootstrap.sh
```
...
```bash
cd; curl -#L https://github.com/lukegiuliani/dotfiles/tarball/master | tar -xzv --strip-components 1 --exclude={README.md,bootstrap.sh}
```
